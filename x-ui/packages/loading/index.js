...
import xLoading from './index.vue'
...
const $loading = createApp(xLoading, {obj}).mount(typeof document !== 'undefined'?typeof document.createElement !== 'undefined'?document.createElement('div'):'':'')
// console.log($loading);
const Loading = {
